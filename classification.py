...
Distracted_features = pd.read_csv('epochs_combined/Distracted/new_features_Distracted_combined.csv')
Focused_features = pd.read_csv('epochs_combined/Focused/new_features_Focused_combined.csv')
neutral_features = pd.read_csv('epochs_combined/neutral/new_features_neutral_combined.csv')
...
classifiers = {
    'Best SVM': best_svm_model,
    'Best KNN': best_knn_model,
    'Best Random Forest': best_rf_model,
    'Best Gradient Boosting': best_gb_model,
    'Weighted Voting Classifier with Gradient Boosting': voting_classifier_ovr
}
